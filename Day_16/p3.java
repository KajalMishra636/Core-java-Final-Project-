...
/*
  ...
  In a write class , the private data can be set (written to ) from outside the class 
...
public class p3 {
	...
	public static void main(String[] args) {
		//Create a new WritOnlyPerson object 
		WriteOnlyPerson person = new WriteOnlyPerson();
		
		//set the name using the setter method 
		person.setName("Bob");
		
		//Attempting to read the name will cause  compilation error 
