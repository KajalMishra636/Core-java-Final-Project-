       ...
       // Splits the text based on the defined regex pattern
         ...
         //Loop to print each word separately 
        		  for (String word : words) {
        			  /*
        			    String word	Declares a new variable named word of type String.
: words	Means “from the array (or collection) named words.”
Full syntax	Can be read as: “For each word in the array words, do the following
        			   * */
