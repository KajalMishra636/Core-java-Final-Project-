...
3. Resizable:
Grows in size when capacity is exceeded (default capacity is 10, typically doubles).
...
public class demo11 {
   public static void main(String [] args) {
	   //Create a Vectors to store user names
	   ...
	   System.out.println("Update User List:" + users);
	   ...
	   System.out.println("Iterating using for loop:");
	      for(int i= 0; i < users.size();i++) {
	    	  ...
	    	  //Iterate using an enhanceed for loop 
	    	  System.out.println("Iteraing using enhanceed for loop:");
