...
public class demo12 {
     ...
     //Create a Stack to store text edits
    	   ...
    	   edits.push("Added bulled points");
    	   ...
    	   System.out.println("Edit after undo: "+edits);
    	   ...
    	   if(edits.contains("Inserted image")) {
    		   System.out.println("The edit 'Inserted image' exists in the stack.");
    			   ...
    			   System.out.println("The edit 'Inserted image ' does not exit in the " +"stack.");
    		   }
    	   ...
    	   //Iterate using an enhanced to loop
